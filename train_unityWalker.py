...
env = UnityEnv('walker', multiagent=True, worker_id = 12).unwrapped
...
for current_episode in range(EPISODE):
    ...
    wandb.log({'actor_loss': actor_loss.item(), 'critic_loss': critic_loss.item(), 'average_reward': average_reward}, step=current_episode)
